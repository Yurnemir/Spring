	...
	<nav class="navbar navbar-inverse">
		...
		<ul class="nav nav-tabs">
			...
			<li role="presentation"><a href="${pageContext.request.contextPath}/etudiant/listeEtudiants">Accueil</a></li>
  			...
  			<li role="presentation" class="active"><a href="${pageContext.request.contextPath}/etudiant/afficheModif">Modifier</a></li>
...
<form:form class="form-horizontal" method="POST" action="modifierEtudiant" modelAttribute="etudiantModif">
